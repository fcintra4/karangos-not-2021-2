    ...
    <>
      ...
      <Toolbar className={classes.toolbar}>
        <Button
          ...
          //Como não tem nenhuma pagina para o cadastro do Karangos, eu coloquei este botão para retornar o mesmo endereço da pagina atual
          onClick={() => history.push('/karangos')}
        >
          Cadastrar novo Karangos
        </Button>
      </Toolbar>
