...
export default function KarangosList() {
  ...
  const columns = [
    { 
      field: 'id', 
      headerName: 'ID do Automovel', 
      width: 140,
      type: 'integer' 
    },
    { 
      field: 'marca', 
      headerName: 'Marca do Automovel', 
      width: 170 
    },
    { 
      field: 'modelo', 
      headerName: 'Modelo do Automovel', 
      width: 180 
    },
    {
      field: 'cor',
      headerName: 'Cor do Automovel',
      width: 150,
    },
    {
      field: 'ano_fabricacao',
      headerName: 'Ano de Fabricação do Automovel',
      width: 250,
      type: 'integer'
    },
    {
    ...
    {
      field: 'placa',
      headerName: 'Placa do Automovel',
      width: 170,
    },
    {      
      field: 'preco',
      headerName: 'Valor do Automovel',
      width: 150,
      type: 'float'
    },
    {
