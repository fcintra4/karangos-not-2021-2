...
import karangos from '../some-cars.png'
...
export default function Startpage() {
    ...
    // variável de estado de objeto
    const [state, setState] = React.useState(() => ({
        about: "",
        figVisible: false
    }))

    //variáveis avulsas usando desestruturação
        ...
        <>
            ...
            <Toolbar className={classes.toolbar}>
                <Button
                    color="secondary"
                    variant="contained"
                    onClick={() => figVisible ? setState({...state, figVisible:false}) : setState({...state, figVisible:true})} //a propriedade da variável de estado "figVisible" deve inverter seu valor
                    >
                    Surpresa!
                </Button>
            </Toolbar>
            ...
            <div className={classes.div}>
                <img src={karangos} alt="Carros antigos" style={{opacity: figVisible ? '1' : '0', height: figVisible ? '591px': '0'}} />
            </div>
        </>
    )
}