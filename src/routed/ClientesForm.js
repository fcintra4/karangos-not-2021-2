...
export default function ClientesForm() {
  ...
  React.useLayoutEffect(() => {
    ...
    if(params.id) {
      ...
      // 2) Carregar o registro especificado na rota para edição
    }
  }, [])
  ...
  function saveData() {
    ...
    if(params.id) {
      ...
      // Chamada a API para criação de um novo registro (verbo POST)
  ...
  function handleBackBtnClick() {
    ...
    // Se o formulário estiver alterador, é necessário
...
<div>
  {'Formulário alterado: ' ifFormTouched}
</div>
*/