        ...
        <Box sx={{
          ...
          <Box component='main' sx={{ margin: '20px'}}>          
            <Switch>       
              ...
              {/* Rota pra o componente de formulário, para cadastrar novo cliente */}
              ...
              {/* Rota pra o componente de formulário, para cadastrar novo karango. 
              A ser construido futuramente  */}
